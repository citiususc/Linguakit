...
# Script que integra 6 funçoes perl: sentences, tokens, splitter, ner_en, tagger e nec_en
...
my $stopwords = "_in_|_of_|_for_|_and_|_the_|_on_";#<string>#CUIDADO COM ESTA VARIAVEL!!!!!!!!!!! hai que especializa-la por lingua
my $prep = "of|for"; #<string>
my $titulo = "sr|sir|dr|miss|mister|mr|mrs";#<string>
##########################################
