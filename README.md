...
It also returns an annotated version of the input text, namely the text is annotated with tags identifying the MAIN_TERMS. Each MAIN_TERM is enriched with a link to its corresponding concept in Wikipedia.
